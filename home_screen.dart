import 'package:e_mart/components/featured_button.dart';
import 'package:e_mart/consts/consts.dart';
import 'package:e_mart/consts/lists.dart';
import 'package:e_mart/widgets_comman/home_buttons.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                itemBuilder: (context , index){
                  return Image.asset(slidersList[index] , fit: BoxFit.fill,).box.rounded.clip(Clip.antiAlias).margin(
                ...
                itemBuilder: (context , index){
                  return Image.asset(secondSlidersList[index] , fit: BoxFit.fill,).box.rounded.clip(Clip.antiAlias).margin(
                    const EdgeInsets.symmetric(horizontal: 8)).make();
                }),
               ...
               Container(
                ...
                itemBuilder: (context,index){
                  return Column(
                        ...
                        ).box.margin(const EdgeInsets.symmetric(horizontal: 5)).roundedSM.white.padding(const EdgeInsets.all(12)).make();
                })
